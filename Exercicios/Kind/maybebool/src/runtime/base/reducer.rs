          ...
          match get_tag(term) {
            ...
            FUN | CTR => {
              ...
              match fid {
                ...
                _Show_ => {
                  if _Show__visit(ReduceCtx { heap, prog, tid, hold, term, visit, redex, cont: &mut cont, host: &mut host }) {
                    continue 'visit;
                  } else {
                    break 'visit;
                  }
                ...
                _IsNone_ => {
                  if _IsNone__visit(ReduceCtx { heap, prog, tid, hold, term, visit, redex, cont: &mut cont, host: &mut host }) {
                    continue 'visit;
                  } else {
                    break 'visit;
                  }
                ...
                _Bool_eql_ => {
                  if _Bool_eql__visit(ReduceCtx { heap, prog, tid, hold, term, visit, redex, cont: &mut cont, host: &mut host }) {
                    continue 'visit;
                  } else {
                    break 'visit;
                  }
            ...
            match get_tag(term) {
              ...
              FUN | CTR => {
                ...
                match fid {
                  ...
                  _Show_ => {
                    if _Show__apply(ReduceCtx { heap, prog, tid, hold, term, visit, redex, cont: &mut cont, host: &mut host }) {
                      continue 'work;
                    } else {
                      break 'apply;
                    }
                  ...
                  _IsNone_ => {
                    if _IsNone__apply(ReduceCtx { heap, prog, tid, hold, term, visit, redex, cont: &mut cont, host: &mut host }) {
                      continue 'work;
                    } else {
                      break 'apply;
                    }
                  ...
                  _Bool_eql_ => {
                    if _Bool_eql__apply(ReduceCtx { heap, prog, tid, hold, term, visit, redex, cont: &mut cont, host: &mut host }) {
                      continue 'work;
                    } else {
                      break 'apply;
                    }
